class Node:
    ...
    def manhattan_distance(self):
        ...
        Raises:
            Exception: If the goal state is not assigned or does not match.
    ...
    def __lt__(self, other):
        """
        Compares two nodes for priority queue operations.

        Args:
            other: Another node to compare with.

        Returns:
            True if this node has a lower priority than the other node, False otherwise.
                """
