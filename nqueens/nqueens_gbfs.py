...
class Node:
    ...
    def manhattan_distance(self):
        queens_pos, attack_cols, attack_pos_diag, attack_neg_diag = self.state
        # print(len(attack_cols) + len(attack_pos_diag) + len(attack_neg_diag))
        return len(attack_cols) + len(attack_pos_diag) + len(attack_neg_diag)
