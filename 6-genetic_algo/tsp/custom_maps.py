# List of all 36 states in Nigeria and FCT with their approximate latitude and longitude
nigeria = [
    ("Abia", 5.5320, 7.4860),
    ("Adamawa", 9.3264, 12.3984),
    ("Akwa Ibom", 5.0360, 7.9128),
    ("Anambra", 6.2209, 7.0677),
    ("Bauchi", 10.3158, 9.8442),
    ("Bayelsa", 4.7500, 6.0833),
    ("Benue", 7.7278, 9.2524),
    ("Borno", 11.8847, 13.1510),
    ("Cross River", 5.9631, 8.3350),
    ("Delta", 5.7047, 5.9339),
    ("Ebonyi", 6.2649, 8.0134),
    ("Edo", 6.3405, 5.6200),
    ("Ekiti", 7.6227, 5.2216),
    ("Enugu", 6.5243, 7.5180),
    ("Gombe", 10.2900, 11.1700),
    ("Imo", 5.5720, 7.0588),
    ("Jigawa", 12.1314, 9.5075),
    ("Kaduna", 10.5105, 7.4165),
    ("Kano", 12.0022, 8.5919),
    ("Katsina", 12.9956, 7.6177),
    ("Kebbi", 12.4500, 4.1998),
    ("Kogi", 7.8004, 6.7396),
    ("Kwara", 8.9669, 4.5624),
    ("Lagos", 6.5244, 3.3792),
    ("Nasarawa", 8.4904, 8.5200),
    ("Niger", 9.6008, 6.5478),
    ("Ogun", 7.1600, 3.3500),
    ("Ondo", 7.2500, 5.1931),
    ("Osun", 7.5629, 4.5196),
    ...
    ("Taraba", 8.8893, 11.3659),
    ("Yobe", 11.7480, 11.9660),
    ("Zamfara", 12.1700, 6.6590),
    ("FCT", 9.0765, 7.3986)
]


# List of all African countries with their approximate latitude and longitude
africa = [
    ...
    ("Congo (Congo-Brazzaville)", -0.228, 15.8277),
...
# List of all world countries with their approximate latitude and longitude
world = [
